...
const SolutionNetworkSection: React.FC = () => {
    return (
        <section className="section" style={{ background: 'linear-gradient(to bottom, #0f172a, #1e293b)' }}>
            <div className="container">
                <AnimatedSection className="text-center">
                    <h2 className="heading-lg" style={{ color: '#38bdf8' }}>الحل الحقيقي ليس بوابة… بل شبكة</h2>
                    ...
                    <div style={{ margin: '3rem auto', maxWidth: '800px', textAlign: 'right' }}>
                        <ul style={{ listStyle: 'none', padding: 0 }}>
                            <li className="card" style={{ marginBottom: '1rem', display: 'flex', alignItems: 'center' }}>
                                <span style={{ color: '#22c55e', marginLeft: '1rem', fontSize: '1.2rem' }}>✔</span>
                    ...
                    <div style={{ marginTop: '3rem' }}>
                        <h3 className="heading-xl" style={{ fontSize: '2rem' }}>
                            ...
                            <span style={{ color: '#fbbf24' }}>بنينا شبكة بوابات.</span>
                        </h3>
                    </div>
                </AnimatedSection>
            </div>
